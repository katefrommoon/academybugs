...
export class ModalPage {
  constructor(page) {
    ...
    this.typeFunctional = page.getByText("Functional", { exact: true });
    //this.typeVisual = page.getByText("Visual", { exact: true });
    this.typeContent = page.getByText("Content", { exact: true });
    this.typePerformance = page.getByText("Performance", { exact: true });
    this.typeCrash = page.getByText("Crash", { exact: true });
